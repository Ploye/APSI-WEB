        ...
        <div class="nav-top">
            <nav class="navbar navbar-default">
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class=""><a> </a></li>
                  <li class="dropdown">
                    <a href="/home" class="dropdown-toggle" data-toggle="dropdown"><i class="lnr lnr-user"></i> <span>{{ Auth::user()->name }}, Logout?</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
                    <ul class="dropdown-menu">
                        <li><a href="/home"> <span>Logout</span></a></li>
                    </ul>
                  </li> 
                </ul>
                </div>
                                ...
                                <div class="col-m">                             
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="mid-2">
                                            ...
                                            <p ><em class="item_price">{{$baju->harga}}</em></p>
                                            <div class="block">
                                        ...
                                        <div class="add">
                                           <a href="{{$baju->id_baju}}/beli" class="btn btn-primary "> Beli Sekarang</a>
                                           <!-- <a href="{{$baju->id_baju}}/Keranjang" class="btn btn-success "> Tambah Keranjang </a> -->
                                           <!-- <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="{{$baju->id_baju}}" data-name="{{$baju->nama_baju}}" data-summary="summary {{$baju->id_baju}}" data-price="{{$baju->harga}}" data-quantity="1" data-image="{{$baju->getavatar()}}">Add to Cart</button> -->
                                        </div>
