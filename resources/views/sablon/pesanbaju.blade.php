    ...
    <div class="container ">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">ISI FORMULIR PEMESANAN BAJU</h3>
            </div>
            <div class="panel-body">
                <form method="POST" action="{{action('PesanbajuController@store')}}" enctype="multipart/form-data">
                    <!-- @php
                            $no = 1;   
                    @endphp -->
                    @csrf
                    <div class="form-group">
                        ...
                        <input name="kode_baju" type="text" class="form-control" value="PO-{{$cs->name}}" readonly>
                    </div>

                    <!-- <div class="form-group">
                        <label>NAMA BAJU</label>
                        <input name="nama_baju" type="text" class="form-control" >
                    </div> -->
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input name="bayar" type="text" class="form-control" >
                    </div> -->
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">WAJIB MELAKUKAN PEMBAYARAN DULU, PEMBERITAHUAN LEBIH LANJUT MELALUI EMAIL</h3>
                </div>
                <!-- <div>
                    WAJIB MELAKUKAN PEMBAYARAN DULU, PEMBERITAHUAN LEBIH LANJUT MELALUI EMAIL
                </div> -->
            </div>
        </div>
    </div>
